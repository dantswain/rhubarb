...
/*
 *  rhubarbClient.php - provides a class for connecting to a
 *  rhubarb IPC server.
 *
 *  For sample usage, see ../sample.php.
 *  
...
/* The error handling in rhubarbClient->connect is intercepted
 * here, allowing us to gracefully handle failures to connect.
 * Errors other than connection errors should still be passed to
 * the regular error handling system. */
